...
const title = document.querySelector('#projet1 .extrait-titre[data-content="p1s2-extrait-titre"]');
const add = (title ? Math.round(title.getBoundingClientRect().height) : 0);
grid.style.setProperty('--extrait-col3-add', `${add}px`);
