...
content["p2-protocole-corps"] = `Le texte est peint sur du tulle. Il est structuré<br>sur la répétition, revenant à chaque fois sur lui-même. À l’intérieur de cette spirale, se glisse par instant une ouverture, une respiration.<br>Le texte tourne sur lui-même jusqu’à ce que je le déchire. J’utilise ensuite ces morceaux de tissus pour réaliser un pansement avec de l’argile<br>que je viens appliquer sur ma poitrine.`;
...
content["p4-intro"] = `Ce travail consiste à chercher des moyens de se frayer un chemin dans l’institution, en y portant les questions cultivées dans l’école.`;
